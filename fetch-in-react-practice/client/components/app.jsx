...
export default class App extends React.Component {
  ...
  addTodo(newTodo) {
    ...
    */
    ...
    fetch('/api/todos', {
      ...
      .then(res => res.json())
      .then(newData => {
        const updateTodos = this.state.todos.concat(newData);
  ...
  toggleCompleted(todoId) {
    ...
    const todoStatus = this.state.todos[index].isCompleted;
    const toggleStatus = { isCompleted: !todoStatus };
    ...
    fetch(`/api/todos/${todoId}`, {
      ...
      .then(updateData => {
        ...
        shallowCopy[index] = updateData;
        this.setState({ todos: shallowCopy });
      })
      .catch(err => console.error('Error in Patch', err));
  }
